...
const Home: NextPage = () => {
  ...
  const spices = [
    ...
    {
      name: "Beef Seasoning",
      description: "A robust and flavorful blend designed to enhance beef dishes.",
    ...
    {
      name: "Fish Powder",
      description: "Aromatic and flavorful, our Fish Powder is made from high-quality fish, providing a rich umami taste to your dishes. Perfect for soups, sauces, and marinades.",
              ...
              <div className="flex space-x-4">
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                  >
                    <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 5.079 3.158 9.417 7.618 11.174-.105-.949-.199-2.403.041-3.439.219-.937 1.406-5.957 1.406-5.957s-.359-.219-.359-1.219c0-1.142.662-1.995 1.488-1.995.703 0 1.042.527 1.042 1.16 0 .704-.449 1.756-.681 2.732-.194.821.412 1.492 1.221 1.492 1.466 0 2.595-1.547 2.595-3.784 0-1.984-1.426-3.368-3.46-3.368-2.357 0-3.739 1.769-3.739 3.597 0 .712.274 1.477.617 1.893.068.083.077.156.057.242-.061.267-.196.796-.223.907-.035.146-.116.177-.268.107-1.001-.465-1.624-1.926-1.624-3.1 0-2.523 1.834-4.84 5.287-4.84 2.781 0 4.943 1.983 4.943 4.628 0 2.757-1.739 4.976-4.151 4.976-.81 0-1.573-.421-1.834-.919l-.498 1.902c-.181.695-.669 1.566-.995 2.097A12.013 12.013 0 0 0 12.017 24c6.624 0 11.99-5.367 11.99-11.988C24.007 5.367 18.641.001 12.017.001z" />
                  </svg>
                </a>
                <a
                  href="#"
